...
% kept as comments and identified as:
%{ ORIGINAL_lines
%  
%}
%
...
function [gridOUTPUT,varargout] = VOXELISE_mod2(gridX,gridY,gridZ,varargin)
...
global meshXmin meshXmax meshYmin meshYmax meshZmin meshZmax % MODIFIED_BY_RICCARDO_TORCHIO
